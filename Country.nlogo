turtles-own
[
  num-S   ;; Number of susceptible agents in the town
  num-E   ;; Number of exposed agents in the town
  num-I   ;; Number of infected agents in the town
  num-R   ;; Number of recovered agents in the town
]
...
to setup-people
  ask turtles
  [
    set num-S round (number-of-agents - initial-outbreak-size) / (count turtles)
    set num-E round initial-outbreak-size / (count turtles)
    set num-I 0
    set num-R 0
  ]
end
...
to go
  if sum [num-E] of turtles = 0 and sum [num-I] of turtles = 0
    [ stop ]
  ask turtles
  [
    agents-leave
...
to agents-leave ;;turtle procedure
  repeat round travelers-per-city * (count link-neighbors) / average-node-degree
  [
...
"" ""
PENS
"susceptible" 1.0 0 -13345367 true "" "plot sum [num-S] of turtles"
"exposed" 1.0 0 -1184463 true "" "plot sum [num-E] of turtles"
"infected" 1.0 0 -2674135 true "" "plot sum [num-I] of turtles"
"resistant" 1.0 0 -7500403 true "" "plot sum [num-R] of turtles"
